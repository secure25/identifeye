...
export default function HomeScreen() {
  ...
  const fetchApplications = async () => {
    ...
    try {
      ...
      setApplications(apps.slice(0, 3).map(normalizeApp));
    } catch (e) {
      console.log("[Home] Failed to fetch applications:", e);
      setApplications([]);
    } finally {
      setLoading(false);
      setRefreshing(false);
  ...
  const quickActions = [
    {
      ...
      bg: C.primaryMuted,
      onPress: () => {
        console.log("[Home] Quick action: Apply for ID");
    ...
    },
    {
      ...
      onPress: () => {
        console.log("[Home] Quick action: Apply for Passport");
        router.push("/application/new");
      },
    },
    {
      ...
      bg: C.accentMuted,
      onPress: () => {
        console.log("[Home] Quick action: Track Status");
    ...
    },
    {
      ...
      onPress: () => {
        console.log("[Home] Quick action: My Profile");
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
            <View>
              ...
              <Text style={{ fontSize: 22, fontWeight: "700", color: "#FFFFFF", fontFamily: "Outfit_700Bold", letterSpacing: -0.3 }}>
                {firstName}
              </Text>
            </View>
          ...
          >
            ...
            <Text style={{ fontSize: 20, fontWeight: "700", color: "#FFFFFF", fontFamily: "Outfit_700Bold", lineHeight: 26 }}>
              {t("digital_identity_hub")}
            </Text>
            <Text style={{ fontSize: 13, color: "rgba(255,255,255,0.65)", marginTop: 6, fontFamily: "Outfit_400Regular" }}>
              {t("south_africa")}
            </Text>
          </View>
        </LinearGradient>
          ...
          <View style={{ marginBottom: 24 }}>
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
              ...
              {applications.length > 0 && (
                <AnimatedPressable
                  onPress={() => {
                    console.log("[Home] View all applications pressed");
            ...
            {loading ? (
              ...
              >
                ...
                <AnimatedPressable
                  onPress={() => {
                    console.log("[Home] Start first application pressed");
                    router.push("/application/new");
                  }}
                >
                  <View
